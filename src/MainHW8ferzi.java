public class MainHW8ferzi {
    ...
    public static void arrangeFerz(char[][] board, boolean[][] logicalBoard, int rowNumber) {
        if (rowNumber == 8) {
            printMatrix(board);
            return;
        }
        ...
        for (int column = 0; column < n; column++) {
            if (logicalBoard[rowNumber][column]) {
                ...
                newBoard[rowNumber][column] = 'F';
                newLogicalBoard[rowNumber][column] = false;
                updateBoard(rowNumber, column, newLogicalBoard);
                arrangeFerz(newBoard, newLogicalBoard, rowNumber + 1);
            }
        }
    }

    public static void arrangeFerz() {
        int N = 8;
        ...
        arrangeFerz(board, logicalBoard, 0);
    }
